...
// More
// material-webcomponents/src/material-button.js /
// @DannyMoerkerke
// DannyMoerkerke - updated to 1.3.0
// Latest commit 3e900bf on Feb 1
// History
// 1 contributor
// 232 lines (194 sloc) 5.66 KB
export class MaterialButton extends HTMLElement {
  ...
  `;
	...
	connectedCallback() {
		...
		const toggleIconSlot = this.shadowRoot.querySelector(
			'slot[name="toggle-icon"]'
		);

		this.hasToggleIcon =
			iconSlot.assignedNodes().length &&
			toggleIconSlot.assignedNodes().length;
		this.toggled = false;
